...
public partial class TrgTel977600000
{
    ...
    public string STablaControl { get; set; } = null!;

    public string DescripcionMulticonexion { get; set; } = null!;

    public string ImporteNetoTotalMultiCon { get; set; } = null!;

    public string ImportePromOtrosCargAsoc { get; set; } = null!;
