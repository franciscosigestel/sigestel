...
public partial class TrgTel977702040
{
    ...
    public string Informativo1 { get; set; } = null!;

    public string Informativo2 { get; set; } = null!;

    public string Informativo3 { get; set; } = null!;

    public string Informativo4 { get; set; } = null!;
