...
public partial class SutFacturas
{
    ...
    /// <summary>
    /// Precio coste Grupo Facturacion
    /// </summary>
    ...
    public virtual SutClientesUsuariosFacturas? SutClientesUsuariosFacturas { get; set; }

    public virtual ICollection<SutDetalleTelefonoFactura> SutDetalleTelefonoFactura { get; set; } = new List<SutDetalleTelefonoFactura>();

    public virtual ICollection<SutResumenConcFactura> SutResumenConcFactura { get; set; } = new List<SutResumenConcFactura>();
}
