...
public partial class SutFacturasPfm
{
    ...
    public virtual ICollection<SutResumenConcFacturaPfm> SutResumenConcFacturaPfm { get; set; } = new List<SutResumenConcFacturaPfm>();
}
