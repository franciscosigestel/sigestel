...
public partial class QryEnviosLineas
{
    ...
    public string NifUsuario1 { get; set; } = null!;

    public string? NombreUsuario { get; set; }

    public string? NifTitular1 { get; set; }
    ...
    public string? CpTitular { get; set; }

    public string? PoblacionTitular { get; set; }

    public string? ProvinciaTitular { get; set; }
    ...
    public string? Ultimaextension { get; set; }
    ...
    public string? CuentaVf2 { get; set; }
